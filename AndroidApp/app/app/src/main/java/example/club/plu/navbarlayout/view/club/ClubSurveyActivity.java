    ...
    private void initView() {
        ...
        mDoneButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.d(TAG, "onClick: selected interest - " + mCheckedInterests.toString() );
                for(Interests interests:mCheckedInterests){
                    ClubApiClient.postUserInterest(Constants.USER_EMAIL, interests.getName());
